    ...
    <section class="page-container">
      ...
      ?>
        <!--END OF PHP SCOPE-->
          ...
          <section id="indicadores" class="carousel slide my-4" data-ride="carousel">
            ...
            <section class="carousel-inner" role="listbox">
              <section class="carousel-item active" style="text-align: center">
                <img class="d-block img-fluid" src="https://www.hdwallpapers.in/download/x_men_apocalypse_banner_poster-1600x900.jpg" alt="First slide">
              </section>
              <section class="carousel-item" style="text-align: center">
                <img class="d-block img-fluid" src="https://blog.cyrildason.com/wp-content/uploads/2016/11/House-MD.png" alt="Second slide">
              </section>
              <section class="carousel-item" style="text-align: center">
                <img class="d-block img-fluid" src="https://mypostercollection.com/wp-content/uploads/2018/07/The-Walking-Dead-poster-4-1024x768.jpg" alt="Third slide">
              </section>
            </section>
          ...
          <section class="row">
            ...
            <section class="col-lg-4 col-md-6 mb-4">
              <section class="card h-100">
                <a href="#"><img class="card-img-top" src="http://images5.fanpop.com/image/photos/32000000/Looper-Movie-Poster-looper-32031468-2560-1920.jpg" alt=""></a>
            ...
            <section class="col-lg-4 col-md-6 mb-4">
                <section class="card h-100">
                  <a href="#"><img class="card-img-top" src="https://iphonewalls.net/wp-content/uploads/2013/05/Fight%20Club%20iPhone%20Wallpaper.jpg" alt=""></a>
                  <section class="card-body">
                    <h4 class="card-title">
          ...
          <section class="col-lg-4 col-md-6 mb-4">
            <section class="card h-100">
              <a href="#"><img class="card-img-top" src="https://thewallpaper.co/wp-content/uploads/2016/10/Game-Of-Thrones-2015-Season-5-Poster-Wallpaper-free-4k-high-definition-amazing-background-wallpapers-pictures-widescreen-1080p-3840x2400-768x480.jpg" alt=""></a>
              <section class="card-body">
                <h4 class="card-title">
            ...
            <section class="col-lg-4 col-md-6 mb-4">
              <section class="card h-100">
                <a href="#"><img class="card-img-top" src="https://thats-normal.com/wp-content/uploads/2015/06/fringe_.jpg" alt=""></a>
                <section class="card-body">
                  <h4 class="card-title">
